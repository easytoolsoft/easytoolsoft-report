...
import com.easytoolsoft.report.engine.data.HorizontalStatColumnDataSet;
...
import com.easytoolsoft.report.engine.data.VerticalStatColumnDataSet;
import com.easytoolsoft.report.engine.query.Queryer;
import com.easytoolsoft.report.engine.query.QueryerFactory;
...
public class DataExecutor {
    ...
    public ReportDataSet execute() {
        ...
        ReportMetaDataSet metaDataSet = new ReportMetaDataSet(metaDataRows, metaDataColumns,
